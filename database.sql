...
--Rogue
INSERT INTO "classes" ("name", "hit_dice", "hit_point_base", "save_prof_1", "save_prof_2", "armor_prof", "tool_prof", "weapon_prof", "feat_id_1", "feat_id_2", "feat_id_3")
...
-- weaponsAndArmor (not currently utilized)
Create Table "weaponsAndArmor" (
"id" serial primary key,
"name" varchar NOT NULL,
...
INSERT INTO "weaponsAndArmor" ("name", "damage", "properties", "ac_bonus")
VALUES ('Greataxe', '1d12 slashing', 'Heavy, two-handed', 0),
('Handaxe', '1d6 slashing', 'Light, thrown (range 20/60)', 0),
('Javelin', '1d6 piercing', 'Thrown (range 30/120)', 0),
('Light Crossbow', '1d8 piercing', 'Ammunition (range 8-/320), loading, two-handed', 0),
('Dagger', '1d4 piercing', 'Finesse, light, thrown (range 20/60)', 0),
('Warhammer', '1d8 bludgeoning', 'Versatile (1d10)', 0),
('Shield', 'none', 'Shield - Increases AC + 2 when worn.', 2),
('Chain Mail', 'none', 'Armor - Changes AC when worn.', 16),
('Leather Armor', 'none', 'Armor - Changes AC when worn.', '11 + Dex Modifier'),
('Shortsword', '1d6 piercing', 'Finesse, light', 0),
('Longbow', '1d8 piercing', 'Ammunition (range 150/600), heavy, two-handed', 0),
('Rapier', '1d8 piercing', 'Finesse', 0),
('Shortbow', '1d6 piercing', 'Ammunition (range 80/320), two-handed', 0),
('Mace', '1d6 bludgeoning', 'none', 0);

-- Inventory Table (not currently utilized)
...
INSERT INTO "inventory" ("gold", "items")
VALUES (75,'Light crossbow w/ 20 bolts, Arcane Focus, dungeoneers pack, 2 daggers'),
(50, 'Greataxe, 2 handaxes, explorers pack, 4 javelins'),
(125, 'Warhammer and a shield, 5 javelins, priests pack, Chain Mail, a holy symbol'),
(125, 'Leather armor, 2 shortswords, dungeoneers pack, longbow w/ quiver (20 arrows)'),
(125, 'Mace, Chain Mail, light crossbow w/ 20 bolts, priests pack, shield and a holy symbol'),
(100, 'Rapier, shortbow w/ quiver (20 arrows), burglars pack, Leather armor, 2 daggers, thieves tools');
